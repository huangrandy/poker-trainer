...
- [ ] Finalize current MVP acceptance criteria in `SPEC_CURRENT_MVP.md`
...
- [ ] Align docs with current stabilization phase
...
- [ ] Add engine tests for hand lifecycle edge cases
  ...
  - Blocks future features: yes
- [ ] Add bot tests for auto-advance stop conditions
  ...
  - Blocks future features: yes
- [ ] Add integration tests for state progression across hands
...
- [ ] Fix any failing tests around `startHand`, `startNextHand`, and `applyAction`
  ...
  - Blocks future features: yes
- [ ] Verify the engine rejects invalid actions instead of silently accepting them
...
- [ ] Confirm bots stop when the hero is current actor
  ...
  - Verification command: `npm test -- src/features/bots/simpleBot.test.ts`
  - Blocks future features: yes
- [ ] Confirm bots stop on `hand_complete`
...
- [ ] Add manual visual acceptance criteria for the table layout
  ...
  - Blocks future features: yes
- [ ] Confirm action history labels remain readable and clearly attributed
...
- [ ] Update roadmap/task docs after stabilization work lands
